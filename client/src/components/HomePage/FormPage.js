        ...
        return(
            <div className='HomePage'>
                ...
                <div className='form buttons'>
                    ...
                    <Input key="phone" ref={this.name} placeholder="Phone">
                    ...
                    <Input key="address" ref={this.name} placeholder="Address of job location"/>
                    <TextArea key="desc" ref={this.name} placeholder="Brief job description"/>

                    <ColoredBorderButton color={this.state.type==='mow'?'red':'blue'} width='100%' height='60px'>
                        Request!
                    </ColoredBorderButton>
