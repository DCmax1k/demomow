...
class TextArea extends Component {
    ...
    render() {
        return(
            <div className='Input TextArea' style={{border: '1px solid '+this.color, backgroundColor: this.backgroundColor}}>
                <textarea onInput={this.setValue} value={this.state.value} style={{backgroundColor: this.backgroundColor, zIndex: 0}} onFocus={() => {this.move(true)}} onBlur={() => {this.move(false)}} />
